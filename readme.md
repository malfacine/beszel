...
- **Processes**: On-demand global process snapshots without control actions or per-process history.
...
- **Processes** - Current CPU, memory, state, user, and start time without collecting command arguments.
...
The global **Processes** page requests lightweight snapshots only while the page is open. See the [process monitoring guide](supplemental/guides/process-monitoring.md) for collection and privacy details.
